...
const buildAssets = {
  css: [...foundationCss, luxeCss, hubCss, patchCss, proSuiteCss].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/css/${f}`),
  js: [...foundationJs, globalJs, searchTypingJs, proSuiteJs].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/js/${f}`),
};
