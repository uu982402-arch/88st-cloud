...
const specialTitles = {
  '/': '레븐 | 카지노·슬롯·보너스 실전 가이드 허브',  '/archive/': '전체 글 아카이브 | 카지노·슬롯·보너스·전략 글 모음',
  '/latest/': '최신글 목록 | 최근 업데이트 글 모음',
  '/popular/': '인기글 목록 | 먼저 읽기 좋은 글 모음',  '/slot/': '슬롯 허브 | RTP·변동성·무료회전 실전 가이드',
...
const specialDescriptions = {
  '/': '카지노·슬롯·보너스·전략 핵심 글을 빠르게 찾고, 실전형 체크포인트까지 한 번에 확인할 수 있는 메인 허브입니다.',  '/archive/': '전체 글을 카테고리 구분 없이 빠르게 훑는 아카이브입니다. 최신 글과 인기 글로도 바로 이동할 수 있습니다.',
  '/latest/': '최근 업데이트된 글을 최신순으로 정리한 목록입니다. 새로 추가된 카지노·슬롯·보너스 글을 빠르게 확인할 수 있습니다.',
  '/popular/': '먼저 읽기 좋은 인기 글을 모은 목록입니다. 입문 글과 운영 글을 빠르게 이어볼 수 있습니다.',  '/slot/': 'RTP·변동성·무료회전·세션 운영 글을 한곳에 모은 슬롯 허브입니다.',
