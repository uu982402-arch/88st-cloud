...
import { ROOT, SITE_ORIGIN, loadPosts, listIndexFiles, routeFromFile, isPublicRoute, normalizePath, writeText } from './lib/site-automation.mjs';
...
console.log(`Sitemap refreshed for ${uniqueUrls.length} public URLs.`);
