...
function wireGuaranteedToggles(){
  ...
  function renderHomePreview(keyword, suffix){
    ...
    target.innerHTML = `<div class="glass-card helper-box"><div class="section-head"><div><h2>바로 이어 보기</h2></div></div><div class="lookup-links"><article class="lookup-link-card"><a href="${googleUrl(q)}" target="_blank" rel="noopener noreferrer">구글에서 보기 ↗</a><p>${esc(q)}</p></article><article class="lookup-link-card"><a href="/muktu-police/check/${domain && domain.includes('.') ? `?domain=${encodeURIComponent(domain)}`:''}">도메인·IP 조회 ↗</a><p>기술 점검으로 이어집니다.</p></article></div></div>`;
  }
