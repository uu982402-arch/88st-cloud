(function(){
  ...
  function renderHome(posts){
    ...
    if (stats) {
      ...
      stats.innerHTML = [
        statCard('CASINO', byCat(posts,'casino').length, '카지노 글 모음', '바카라·룰렛·블랙잭·라이브 글을 겹치지 않는 주제로 더 촘촘히 확장했습니다.', '/blog/', latestByCat('casino')),
    ...
    if (curation) {
      curation.innerHTML = [
        curationCard('casino', '카지노', '바카라·룰렛·블랙잭·라이브에서 먼저 읽을 글과 운영·주의·확장 글을 분리했습니다.', '/blog/', byCat(posts,'casino')),
